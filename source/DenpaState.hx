											...
											new FlxTimer().start(1, _ -> {
												...
												new FlxTimer().start(1.3, _ -> {
													...
													for (i in 0...6) {
														...
														var soulShard:FlxSprite = new FlxSprite().loadGraphic(Paths.image('shard'
															+ Math.min(4, Math.max(i + 1 % 5, 1)), 'splash', false));
													...
													new FlxTimer().start(1.6, _ -> {
														...
														new FlxTimer().start(2.76, function(tmr:FlxTimer) {
															...
															text.setFormat(Paths.font("determination.otf"), 36, FlxColor.WHITE, CENTER,
