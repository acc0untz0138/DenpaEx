...
class Controls extends FlxActionSet
{
	...
	{
		if (ClientPrefs.settings.get("mobileCAlpha") >= 0.1)
			return true;
		else
			return false;
	}
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.NOTE_UP, keysMap.get('note_43'));
				inline bindKeys(Control.NOTE_DOWN, keysMap.get('note_42'));
				inline bindKeys(Control.NOTE_LEFT, keysMap.get('note_41'));
				inline bindKeys(Control.NOTE_RIGHT, keysMap.get('note_44'));
