	...
	override function create() {
		...
		var denpaPatches = [
			...
			[
				...
				"0.8.2",
				"",
				'Do you know how long these take to write?',
				'',
				'4DB33C'
			],
			[
			...
			[
				...
				"0.8.0",
				"",
				'This update is too large to list in a reasonable format. Explore the engine to see the changes!',
				'',
				'4DB33C'
			],
			['0.7.0b',
				...
				+ ' to view.',
				'https://docs.google.com/document/d/1FYPeiyaO2OSlejfHyqvg8VlNH2PbRCJ2PTIDohbZmUI/edit?usp=sharing',
				'6FD2D2'
			],
			['0.7.0',
				'iidol',
			...
			[
				...
				"0.5.0c",
				"",
				'A-FNF+ Score Display, A-FNM Score Dispaly, A-Poison Modifier, A-Autopause Option, A-Gradient Time Bar, F-Main Menu Mouse Controls, F-Tankman Bugs, F-Healthbars, O-Healthbars, RFV-0.5.0c',
			...
			[
				...
				"0.4.0e",
				"",
				'A-Time Text Boppin, A-Cutscene Options, A-Replay Cutscene Option in Pause Menu, A-Bar-less Time Bar Options, A-Pause Options, F-Song Card Appearing During Cutscenes, F-Healthbar Offsets, F-Positionings for Score Displays, F-Pixel GF Being Flipped, RFV-0.4.0e',
				'',
				'998844'
			],
			[
				...
				"0.4.0d",
				"",
				'A-Increased Max and Min Zoom on Chara Editor, A-Increased Scale Max, F-Lag on Chart Editor, F-Tints, F-Chara Editor BPM, R-Skunked Pause Options, RFV-0.4.0d',
				'',
				'998844'
			],
			[
				...
				"0.4.0c",
				"",
				'A-Options to Customize Character Trail, A-Option to Disable Combo Pop-up, A-Cooler Looking BGScroll in Pause Menu, A-Tints, RFV-0.4.0c',
				'',
				'998844'
			],
			[
				...
				"0.4.0b",
				"",
				'A-Sum Graphics, A-Fullscreen Toggle, A-Splash Screen, A-UI Skins, A-The Rest of Sound Test, A-Healthbar Offsets, A-Reset Settings Hotkey, A-New Events to Mess with the Cameras, A-Colour Tweens to Chart Editor, F-Countdown Sprite Sizings, F-Chara Editor Get Dom Colour, F-MOST setDefaultDrawTarget Warnings, F-Sound Test not Keeping Track of Yer Song and Album, RFV-0.4.0b',
				'',
				'998844'
			],
			...
			[
				...
				"0.3.1",
				"",
				'A-Beatmap (Ehhh...), A-Crit Mechanic, A-Song Credits Card, A-Rating Saving/Display in Freeplay, A-Cool First Time Opening Main Menu Intro, U-GF and Senpai Icons, U-Character Editor to Have Nearly Identical Stage Replications, U-Made Sarv Score Display More Accurate, U-Ratings Display, U-Max Combo to 999,999, F-Lacking Pixel Perfect and WTF Graphics, F-Combo Graphics, U-Sick Graphic, F-BPM on Title Screen, F-Title Screen Logo Placement, F-GF Not Crying When You MISS a Note, F-Botplay not Always Getting Perfects, R-Leftover Easy Difficulty Stuff, RFV-0.3.1',
				'',
				'B60000'
			],
			[
				...
				"0.3.0b",
				"",
				'A-Music to The Editors, A-Stage Changer to Character Editor, O-More Stuff, F-Health Icon Cut Offs, U-Discord RPC, U-Sarvente Lucifer, U-Character Editor Layout, U-Chart Editor Layout, RFV-0.3.0b',
				'',
				'FFFFFF'
			],
			[
				...
				"0.3.0",
				"",
				'A-Camera Movement on Note Hit, A-Cool Score Display Options, A-BM Showcase Song/Stage, A-Perfect and WTF Ratings, A-CrossFade Settings, A-Ratings Display, C-Ratings, F-CROSSFADE(FRFR)!!!, F-Pixel Notes, O-A Lot of Stuff, RFV-0.3.0',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource-Denpa-Engine/commit/74167d07955d4e59fb3217e62bd6d8fc0556ed9b',
				'FFFFFF'
			],
			[
				'0.2.4b',
				...
				"0.2.4b",
				"",
				'A-Dual/Triple Colour HP Bars, A-Angle Snap Icon Animation, R-Aggro Swing, F-Crossfade stuff, RFV-0.2.4b',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource-Denpa-Engine/commit/379e7f8ff93db9ba46f9402b71dfc19c3bf9f72d',
				'FFFFFF'
			],
			[
				'0.2.4',
				...
				"0.2.4",
				"",
				'A-A Boatload Of Options To Toggle, F-A Lot Of Multikey Related Errors, RFV-0.2.4',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/ecd982babbd4ab394426a22c67f58d8cb06fbcac',
				'FFFFFF'
			],
			[
				'0.2.3c',
				...
				"0.2.3c",
				"",
				'A-Insanity Difficulty, A-Multikey Support, C-Botplay Text To "AUTO", U-Patch Note Menu To Be More Descriptive, F-Not Being Able To Enter In Text Boxes, RFV-0.2.3c',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/57eb62df518a79c051aabd8a6094bde39348a170',
				'F499C2'
			],
			[
				'0.2.3b',
				...
				"0.2.3b",
				"",
				'U-Credits, U-Secret Song Functionality, RFV-0.2.3b',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/7a21260bca58f3a4f47cf23c2f88eaf1f695baa3',
				'F499C2'
			],
			[
				'0.2.3',
				...
				"0.2.3",
				"",
				'A-This Menu, A-BG Scroll In Master Editor, F-BG Scroll Lag, F-BG Scroll Size, RFV-0.2.3',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/3ab55597186e0be2c002b08bbd10154237fb3d42',
				'F499C2'
			],
			[
				'0.2.2',
				...
				"0.2.2",
				"",
				'U-Credits, U-Disruption, U-CF Color, F-CrossFade, A-CrossFade Notes, A-Icon Flinch, C-OutdatedState, RFV-0.2.2',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/1305277c8426c1cb43606fd183cb43413f3d854b',
				'8DC642'
			],
			[
				'0.2.1c',
				...
				"0.2.1c",
				"",
				'A-Random Mode, F-SecVoices in Chart, A-Chart Effects, M-FreePlay Scroll not C Colors, M-Options Menu Scroll, RFV-0.2.1c',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/a85c17c48328bc9ad619231a172ea0353537109d',
				'FFDD66'
			],
			[
				'0.2.1b',
				...
				"0.2.1b",
				"",
				'F-FreePlay Scroll, RFV-0.2.1b',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/07e45c5ae469462f344511ca5e5bb26afcd22b5b',
				'FFDD66'
			],
			[
				'0.2.1',
				...
				"0.2.1",
				"",
				'N-Combo Graphics, Cool Menu Stuff, RFV-0.2.1',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/07057074db7c93662eaf992cd2f224a4aec1f672',
				'FFDD66'
			],
			[
				'0.2.0c',
				...
				"0.2.0c",
				"",
				'A-Character Select Song, A-Title Song, C-Title BPM, RFV-0.2.0c',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/583309cca153ab9fb55e60f5e0ce4cda58b1a3ab',
				'DF6C21'
			],
			[
				'0.2.0b',
				...
				"0.2.0b",
				"",
				'U-Credits, M-RPC More Descriptive, RFV-0.2.0b',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/97101b422b7512d51cf38802a8167aed858ddff4',
				'DF6C21'
			],
			[
				'0.2.0',
				...
				"0.2.0",
				"",
				'A-Crossfade, RFV-0.2.0',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/54e3f231b38e59a6c1537559cc7036de9491c1ed',
				'DF6C21'
			],
			[
				'0.1.3b',
				...
				"0.1.3b",
				"",
				'A-CrossFade (Broken), A-CrossFade Test Song, RFV-0.1.3b',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/2b436771dceaa00205d4ac2f563bfb401766e89d',
				'0088A0'
			],
			[
				'0.1.3',
				...
				"0.1.3",
				"",
				'R-Test Code, A-Modapps Disruption, U-MM Graphics/Layout, F-Credits Text, RFV-0.1.3',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/61273847c77579d227a2d6cbc35a9e28e56aee70',
				'0088A0'
			],
			[
				'0.1.2',
				...
				"0.1.2",
				"",
				'A-Test Song For SecVoices, A-Credits Text, A-SecVoices, RFV-0.1.2',
				'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/4cb67777c939f33f261ff715eeaec2d75931d1dc',
				'99AA0D'
			]
		];
		...
		for (i in 0...patchStuff.length) {
			...
			if (isSelectable) {
				...
				if (patchStuff[i][6].length != 6)
					patchStuff[i][6] = 'FFFFFF';
