...
class PatchState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var denpaPatches = [ //Ver - Icon name - Update Ver - Update Name - Description - Link - BG Color
			['DenpaEx'],
			['0.8.2',		'100',			"0.8.2", "", 'my brother in christ just go to the https://github.com/justAMZ/DenpaEx/#fork-features-unfinished-list :cry:',	'https://github.com/justAMZ/DenpaEx/#fork-features-unfinished-list',	'202020'],
			[''],
			['Denpa Engine'],
