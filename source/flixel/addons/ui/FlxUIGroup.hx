 ...
 * @author Lars Doucet 
 * BRO LARS ARE YOU DRUNK MAN WHAT THE FUCK IS THAT CALCBOUNDS CODE ???????
 * TODO: REWRITE THAT FUCKING CALCBOUNDS FUNCTION CODE HOLY SHIT???? IT FUCKS UP CHECKBOXES SO BAD
 */
