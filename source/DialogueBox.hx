									...
									switch (dialog) {
										case "and ":
											...
											new FlxTimer().start(0.1, function(_:FlxTimer) {
												...
												shakeTween = FlxTween.shake(face, 0.08, 0.2, flixel.util.FlxAxes.XY, {onComplete: function(_:FlxTween) {
													shakeTween = null;
												}});
											});
										case "and HER ":
											swagDialogue.delay = 0.04;
											bgLight.color = FlxColor.WHITE;
									}
								};
