...
class HUD extends FlxSpriteGroup {
    ...
    public function new()
    {
		...
		if (ClientPrefs.settings.get("watermarks"))
		{
			...
			noGhostTapping.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
			...
			noBotplay.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
			...
			songCreditsTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, LEFT, FlxTextBorderStyle.SHADOW, FlxColor.BLACK);
			songCreditsTxt.active = false;
			add(songCreditsTxt);
			remixCreditsTxt = new FlxText(songCard.x, songCreditsTxt.y + 40, 0, "");
			remixCreditsTxt.scrollFactor.set();
			remixCreditsTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, LEFT, FlxTextBorderStyle.SHADOW, FlxColor.BLACK);
