...
class CoolUtil
{
	...
	public static var baseIcons:Array<String> = ['bf', 'bf-old', 'bf-pixel', 'dad', 'face', 'gf', 'mom', 'monster', 'parents', 'pico', 'senpai', 'senpai-pixel', 'spirit', 'spirit-pixel', 'skid-and-pump', 'tankman'];
